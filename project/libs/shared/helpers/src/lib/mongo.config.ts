...
import { MongoConfiguration } from './alt-mongo-validation/mongo.env';
...
// Вариант валидации через class-validator
...
// Joi
// export default registerAs('mongoDb', getDbConfig);
